...
3. [배운 점 및 도전 과제](#3-배운-점-및-도전-과제)
   ...
   3. [TypeScript, Redux Toolkit, Jest를 사용한 공격, 방어 계산 함수 작성과 테스트](#35-typescript-redux-toolkit-jest를-사용한-공격-방어-계산-함수-작성과-테스트)
   4. [사용자의 기기 선호 테마에 따라 다크/라이트 테마 지원](#45-사용자의-기기-선호-테마에-따라-다크라이트-테마-지원)
   5. [라이트 하우스 점수 개선 성능 30점대에서 98점으로 상승](#55-라이트-하우스-점수-개선-성능-30점대에서-98점으로-상승)
