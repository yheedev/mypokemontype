...
export default function Selector() {
  return (
    <Card>
      <div className="mb-0 justify-evenly font-['Noto_Sans_KR']">
        <SelectorMode />
...
// import ContainerTypes from '../../../../legacy/src/components/ContainerTypes'
...
//   useEffect(() => {
//     const currentMode =
//       location.pathname === `/${lang}/defense` ? 'defense' : 'offense'
//     setMode(currentMode)
...
//               $darkMode={darkMode}
//             >
//               <span className="OptionText OffenseText">
...
//               $darkMode={darkMode}
//             >
//               <span className="OptionText DefenseText">
...
//   .OffenseText {
//     color: ${(props) =>
//       props.$selectedMode ? 'var(--offenseRec)' : 'var(--color-text)'};
//     ${(props) =>
//       props.$darkMode === 'dark' &&
//       css`
//         color: ${props.$selectedMode
//           ? 'var(--offenseRec)'
//           : 'var(--color-text)'};
//       `}
//   }
...
//   .DefenseText {
//     color: ${(props) =>
//       props.$selectedMode ? 'var(--defenseRec)' : 'var(--color-text)'};
//     ${(props) =>
//       props.$darkMode === 'dark' &&
//       css`
//         color: ${props.$selectedMode
