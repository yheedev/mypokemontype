...
export const modeStyle =
  'relative z-10 flex-1 rounded-[7px] py-[9px] text-center text-[17px] font-bold tracking-[.06em] transition-colors duration-300 sm:py-[14px] sm:text-[18px] lg:py-[17px] lg:text-[20px]'
